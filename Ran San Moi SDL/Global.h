#pragma once
#include <D:\SDL\Ran San Moi SDL\SDL2\include\SDL.h>
#include <stdlib.h>
#include <time.h>

#define BOARD_CELL			16   // kích thước của 1 ô, nên lúy thừa là 2
#define	BOARD_HORZ			48  //  số lượng ô theo chiều ngang
#define	BOARD_VERT			30 //   số lượng ô theo chiều dọc

// 18 màu sắc có thể sử dụng trong trò chơi
...
void rectDraw(int x, int y, int h, unsigned long color);
